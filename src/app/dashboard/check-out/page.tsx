...
export default function DashboardCheckOutPage() {
  return (
    <section className="mx-auto max-w-3xl space-y-6">
      ...
      <div>
        <h1 className="text-2xl font-semibold">Check-out Form Settings</h1>
        <p className="text-gray-600">Customize dynamic fields shown to attendees on the Check-out form.</p>
      </div>
      <FormEditor form="CHECK_OUT" />
    </section>
  );
}
